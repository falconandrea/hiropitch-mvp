    ...
    <table className='w-full flex-1'>
      <thead>
        <tr className='text-left [&>th]:px-4 [&>th]:pb-4 [&>th]:text-xs [&>th]:font-normal first:[&>th]:pl-2 lg:[&>th]:text-sm'>
          <th className='w-1'>#</th>
          <th>Collection</th>
          <th className='hidden md:table-cell'>To pay to be part</th>
        </tr>
      </thead>
              ...
              <div className='flex items-center gap-x-3 pr-6 md:gap-x-6'>
                ...
                <div>
                  ...
                  <p className='text-xs font-normal text-slate-500 md:hidden'>
                    Floor:{' '}
                    <span className='font-semibold'>{item.floor} Sol</span>
                  </p>
                </div>
              </div>
            </td>
            <td className='text-right'>{item.floor} Sol</td>
          </tr>
        ))}
      </tbody>
    </table>
